...
namespace DocargestSeguros
{
    public partial class FormularioClientes : Form
    {
        ...
        public FormularioClientes(BDMySQL bd)
        {
            InitializeComponent();
            this.bd = bd;
        ...
        public FormularioClientes(BDMySQL bd, int codigo, string dni, string nombre, string apellidos, MySqlDateTime fechaAlta, MySqlDateTime fechaNac, string codPostal, string via, string direccion, int poblacion, int provincia, string telefono, string email)
        {
            InitializeComponent();
